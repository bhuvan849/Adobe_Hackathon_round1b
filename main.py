...
# Use absolute paths expected inside the Docker container
INPUT_DIR = "/app/input"
...
def main():
    ...
    try:
        # --- FINAL INPUT LOGIC TO MATCH YOUR PROVIDED JSON ---
        ...
        if not all_sections:
            ...
            # 3. Initialize Engine and Rank Sections
